    ...
    <form method="POST" action="/rooms/{{$room->id}}">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control @error('room') is-invalid @enderror" type="text" value="{{$room->room}}" id="room" name="room" />
                    @error('room')
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select class="form-control @error('room_type_id') is-invalid @enderror" id="room_type_id" name="room_type_id">
                        ...
                        @if($type->id == $room->roomType()->first()->id)
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select name="room_status_id" id="room_status_id" class="form-control @error('room_status_id') is-invalid @enderror">
                        ...
                        @if($status->id == $room->roomStatus()->first()->id)
