...
<div class="card card-custom">
    ...
    <!--begin::Form-->
    <form method="POST" action="/room/types/{{$type->id}}">
        @csrf
        @method('PUT')
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control @error('type') is-invalid @enderror" value="{{ $type->type }}" id="type" name="type" />
                    @error('type')
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control @error('rate') is-invalid @enderror" id="rate" name="rate" value="{{$type->rate}}" />
                    @error('rate')
